...
const QASystem = ()=>{
    ...
    const handleGenerateQuestions = async ()=>{
        if (!selectedDataset) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please select a dataset to generate questions.");
            return;
        }
        setIsGenerating(true);
        const prompt = "Generate ".concat(numQuestions, " ").concat(difficulty, " difficulty questions based on the dataset: ").concat(selectedDataset.filename, ".");
        try {
            const token = localStorage.getItem("token");
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                    value: (_selectedDataset_filename = selectedDataset === null || selectedDataset === void 0 ? void 0 : selectedDataset.filename) !== null && _selectedDataset_filename !== void 0 ? _selectedDataset_filename : "",
                                                    onValueChange: (val)=>{
                                                        const dataset = datasets.find((d)=>d.filename === val);
                                                        setSelectedDataset(dataset !== null && dataset !== void 0 ? dataset : null);
                                                    },
                                                    children: [
...
_s(QASystem, "n14Of9OCQvaasHarOJfkEEsrrJo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_db306a38._.js.map